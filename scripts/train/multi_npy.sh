...
DATA_FILE="${DATA_FILE:-$ROOT/data/station/pv/f1-9.npy}"
CKPT="${CKPT:-$ROOT/out/scale_up_3_shuffle/checkpoints/best-0.172.pth}"
PROJ_DIR="${PROJ_DIR:-out/multi_npy}"
...
python train.py \
    ...
    --select_indices 0,7 --feature_used 0,1,2,6,7 --forecast_len 96 --do_normalize True
