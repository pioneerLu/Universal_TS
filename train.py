...
if __name__ == "__main__":
    ...
    precision_label = str(args.precision)
...
############################################################################
#
# RWKV-7 {precision_label.upper()} on {args.num_nodes}x{args.devices} {args.accelerator.upper()}, bsz {args.num_nodes}x{args.devices}x{args.micro_bsz}={args.real_bsz}, {args.strategy} {'with grad_cp' if args.grad_cp > 0 else ''}
#
...
"""
    ...
    if args.validate_only==1:
        ...
        model = model.to(dtype=torch.bfloat16 if args.precision == 'bf16' and device.type == "cuda" else torch.float32)
